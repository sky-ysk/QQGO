...
## 版本 0.9 — 2026-06-01 已完成

### 历史消息查询

| 命令 | 说明 |
|------|------|
| `/history <qq> --from YYYY-MM-DD --to YYYY-MM-DD` | 按时间范围查询历史消息 |

### 全文搜索

| 命令 | 说明 |
|------|------|
| `/searchmsg <关键词> [qq]` | 在历史消息中搜索内容（支持全局和指定会话） |

搜索使用 SQLite FTS5 全文搜索引擎，每条匹配消息显示前后各 1 条上下文。
